...
md`# HW05 Strong baseline (2pt)`
)}

function _group1(d3,group,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 2000
    ;
...
function _group(FileAttachment){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["output.json", {url: new URL("./files/86007b1fb24dc5b5c32dc24a60d5e7f436656937c767d4f5692c36779333462315b481726bfd906a83bdbefd33be4f9be3bcfa815b80ae50717707fe11fb3b15.json", import.meta.url), mimeType: "application/json", toString}],
    ["group.json", {url: new URL("./files/1dd40d06401ea69f1e3cdcdd2ea129638845754fd623a8bf2aa6d0166b0f30f62e0f37f4db284d32f533c12c9eb02fc317f87c1e6dc61364e3e0d02b5d5ceeb7.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("group1")).define("group1", ["d3","group","drag","url_list","invalidation"], _group1);
  main.variable(observer("group")).define("group", ["FileAttachment"], _group);
