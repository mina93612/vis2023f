...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>在參與問卷的人中，以工作室的藝術工作者為主要群體。</li>
    <li>多數藝術工作者選擇透過減少包裝的方式來降低碳排放。</li>
    <li>美術館的藝術工作者不僅在減少包裝方面採取行動，還更加注重節約工作場所的能源，相對而言，使用再生材料在他們的選擇中並未居前三。</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#1C1C1C","#434343","#3A3226","#B5495B","#E87A90","#D05A6E"])
  .unknown("#BEBEBE")
)}
